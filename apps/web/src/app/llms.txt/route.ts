...
export async function GET() {
  ...
  const content = [
    ...
    "",
    "## What EstateDesk Does",
    "- Full property management OS: tenants, leases, units, staff roles, reports",
    "- Kenya-first payments: M-Pesa STK/paybill, KCB IPN, multi-bank virtual accounts",
    "- Combined period bills allocating service/garbage/security/water before rent",
    "- Water billing + offline caretaker meter queues with background sync",
    "- Double-entry accounting, AR/AP aging, books health, owner distributions",
    "- KRA eTIMS/eRITS-ready receipts and live submit when credentials configured",
    "- Public vacancy SEO listings for tenant discovery",
    "- WhatsApp Business billing chatbot intents (balance, bill, pay, receipt)",
    "",
    "## Why EstateDesk Is Better",
    "- Built for Kenyan rental ops—not a rebranded foreign PMS",
    "- Replaces Excel/notebooks/WhatsApp-only workflows with one auditable system",
    "- Field reality: offline metering, unit QR, SLA issues, bilingual caretaker UI",
    "- Tax readiness: eTIMS-shaped receipts, taxpayer profiles, rental returns",
    "- Marketing + ops in one product: vacancy pages that rank and convert",
    "",
    "## Core Topics",
