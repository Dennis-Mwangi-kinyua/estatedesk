  ...
  return (
    <div className="px-5 py-10 text-center sm:px-6 sm:py-12">
      ...
      <p className="mx-auto mt-2 max-w-lg text-sm leading-6 text-muted-foreground">
        There are no lease records on file yet. Leases are created when you onboard a
        tenant and assign them to a unit with rent terms.
      </p>
      ...
      <div className="mx-auto mt-8 grid max-w-3xl gap-3 sm:grid-cols-3">
        <div className="rounded-2xl border border-border bg-muted/10 p-4 text-left">
          ...
          <p className="mt-2 text-sm font-semibold text-foreground">Add tenant</p>
          <p className="mt-1 text-sm leading-6 text-muted-foreground">
            Capture tenant details, next of kin, and contact information.
          </p>
        </div>
        <div className="rounded-2xl border border-border bg-muted/10 p-4 text-left">
          <p className="text-xs font-semibold uppercase tracking-[0.14em] text-muted-foreground">
          ...
          <p className="mt-1 text-sm leading-6 text-muted-foreground">
            Select a vacant unit and set monthly rent, deposit, and due day.
          </p>
        </div>
        <div className="rounded-2xl border border-border bg-muted/10 p-4 text-left">
          <p className="text-xs font-semibold uppercase tracking-[0.14em] text-muted-foreground">
          ...
          <p className="mt-2 text-sm font-semibold text-foreground">Activate lease</p>
          <p className="mt-1 text-sm leading-6 text-muted-foreground">
            Once active, rent charges and payment tracking begin automatically.
          </p>
        </div>
      </div>
    </div>
