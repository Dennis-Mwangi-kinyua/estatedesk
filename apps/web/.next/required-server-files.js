self.__SERVER_FILES_MANIFEST={
  ...
  "config": {
    ...
    "images": {
      ...
      "remotePatterns": [
        ...
        {
          "protocol": "https",
          "hostname": "your-s3-bucket.s3.af-south-1.amazonaws.com",
          "pathname": "/**"
        },
        {
          "protocol": "https",
          "hostname": "s3.af-south-1.amazonaws.com",
          "pathname": "/your-s3-bucket/**"
        }
      ],
      "qualities": [
        75
    ...
    "outputFileTracingRoot": "/home/baba-nyakio/Desktop/estatedesk-main",
    ...
    "transpilePackages": [
      "@estatedesk/config",
      "@estatedesk/contracts",
      "@estatedesk/db-kit",
      "@estatedesk/auth-sdk",
      "@estatedesk/service-client",
      "@estatedesk/events",
      "@estatedesk/public-vacancy",
      "@estatedesk/notifications"
    ],
    "turbopack": {
      "root": "/home/baba-nyakio/Desktop/estatedesk-main"
    },
    "distDirRoot": ".next",
    "_originalRedirects": [
      {
  ...
  "appDir": "/home/baba-nyakio/Desktop/estatedesk-main/apps/web",
