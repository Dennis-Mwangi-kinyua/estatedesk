          ...
          >
            <Link href={listing.href} className="block">
              <div className="relative aspect-[4/3] overflow-hidden bg-slate-100 dark:bg-slate-800">
                {listing.hasImage ? (
                  ...
                  <div className="flex h-full w-full items-center justify-center bg-[linear-gradient(135deg,#f8fafc_0%,#e2e8f0_100%)] p-3 dark:bg-[linear-gradient(135deg,#0f172a_0%,#1e293b_100%)]">
                    <div className="flex flex-col items-center gap-2 text-center">
                      <span className="flex h-10 w-10 items-center justify-center rounded-xl border border-slate-200 bg-white text-slate-800 shadow-sm dark:border-white/10 dark:bg-slate-950 dark:text-slate-100">
                ...
                <div className="absolute bottom-2 left-2 rounded-full bg-white px-2.5 py-1 text-[11px] font-semibold text-slate-900 shadow-sm backdrop-blur dark:bg-slate-950 dark:text-white">
              ...
              <div className="mt-auto border-t border-slate-100 pt-3 dark:border-white/10">
                ...
                <div className="mt-3 grid grid-cols-[2.5rem_1fr] gap-2">
                  <a
                    ...
                    className="inline-flex h-10 items-center justify-center rounded-lg border border-slate-200 bg-white text-slate-800 shadow-sm transition hover:bg-slate-50 dark:border-white/15 dark:bg-slate-950 dark:text-white dark:hover:bg-slate-800"
        ...
        >
          ...
          <div className="grid w-full grid-cols-2 items-center gap-2 sm:grid-cols-[1fr_auto_1fr]">
            <button
              ...
              className="inline-flex h-11 items-center justify-center gap-2 rounded-lg border border-slate-300 bg-white px-3 text-sm font-semibold text-slate-900 shadow-sm transition hover:border-emerald-600 hover:bg-emerald-50 hover:text-emerald-800 disabled:cursor-not-allowed disabled:border-slate-200 disabled:bg-slate-50 disabled:text-slate-400 dark:border-white/20 dark:bg-[rgb(15,23,42)] dark:text-slate-100 dark:hover:border-cyan-200 dark:hover:bg-cyan-200/15 dark:hover:text-cyan-100 dark:disabled:bg-[rgb(15,23,42)] dark:disabled:text-slate-600"
              aria-label="Previous vacancy page"
            >
              <ChevronLeft className="h-4 w-4" />
              Previous
            </button>
            <span className="hidden h-11 min-w-28 items-center justify-center rounded-lg border border-slate-200 bg-white px-3 text-sm font-bold text-slate-900 shadow-sm dark:border-white/15 dark:bg-slate-950 dark:text-white sm:inline-flex">
            ...
            <button
              ...
              className="inline-flex h-11 items-center justify-center gap-2 rounded-lg bg-slate-950 px-3 text-sm font-semibold text-white shadow-sm transition hover:bg-slate-800 disabled:cursor-not-allowed disabled:bg-slate-200 disabled:text-slate-500 dark:bg-slate-950 dark:text-white dark:hover:bg-slate-800 dark:disabled:bg-slate-800 dark:disabled:text-slate-500"
