...
import { submitManualRentMpesaAction } from "./actions";
            ...
            <div className="grid gap-5 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:items-start">
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-neutral-500">
                  Paste the confirmation message after paying rent. Your organization will verify it before a receipt is issued.
                </p>
              </div>

              <form action={submitManualRentMpesaAction} className="space-y-3">
                <div>
                  <label htmlFor="amount" className="text-xs font-semibold uppercase tracking-[0.12em] text-neutral-500">
                    Amount paid
                  </label>
                  <input
                    id="amount"
                    ...
                    className="mt-1 h-11 w-full rounded-lg border border-neutral-200 bg-white px-3 text-sm font-medium text-neutral-950 outline-none transition focus:border-neutral-400"
                    required
                  />
                </div>

                <div>
                  <label htmlFor="transactionMessage" className="text-xs font-semibold uppercase tracking-[0.12em] text-neutral-500">
                  ...
                  <textarea
                    ...
                    className="mt-1 w-full resize-y rounded-lg border border-neutral-200 bg-white px-3 py-3 text-sm text-neutral-950 outline-none transition focus:border-neutral-400"
                    required
                  />
                </div>
